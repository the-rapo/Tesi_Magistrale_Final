...
model, transformer = Load_Poly_model('models/univariate/Poly/deg4_low_2')
...
# Model_Plot(model, x_transform=transformer, n=300, Single_Param=True)
...
Delibr_Plot(model, data, x_transform=transformer, modelname=None, parameters=None, save=None, Single_Param=True)
